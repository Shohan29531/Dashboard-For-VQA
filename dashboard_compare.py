...
heatmaps = html.Div(
    [
        ...
        html.Div(
            ...
            ], className='five columns'  # Change to one column
        ),
...
def save_data(n_clicks):
    if n_clicks > 0:
        ...
        return "**Saved at: " + current_time + "**", updated_list, None, [], {}, ''
    else:
        return "*Not Saved*", dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update
